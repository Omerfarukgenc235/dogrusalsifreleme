...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int m;
            Console.WriteLine("Lütfen m değerini giriniz");
            ...
            Console.Write("Doğrusal şifrelenmiş hali = ");
            ...
            {
                olacak = sayi[c] ;
                hamsayi = (olacak - n)*oldumu;
                modlu = Mod(hamsayi, 29);
                foreach (var x in list)
                {
                    if (x.Harfid == modlu)
                    {
